...
### 第3条 (目的)
1. 本会は、CTFなどを通じてサイバーセキュリティに関わる知識を修得することで、セキュリティリテラシーを高めることを目的とする。

### 第4条 (活動)
1. 本会は、前条目標を達成するために次の活動をする。  
    1. 毎週1~2回、会員同士で集まりCTFを解く。 
    2. 必要に応じて、CTFを解くために必要な知識を習得するために講習会を開く。
2. ただし、定期試験2週間前は一切の活動を行わない。
<br>
<br>

## **第2章 会員**
### 第5条 (資格)
1. 以下に該当するものが参加資格を有する。
    1. 釧路工業高等専門学校に在籍する本科生および専攻科生であること。
    2. 本会の理念に賛同し、参加を希望するもの。
### 第6条 (会員条件)
1. 会員は月に1度、CTFの進捗状況を報告する。
2. 前項は次の条件を満たすと判断された場合、特別に免除される。  
